...
- (void)viewDidLoad {
    ...
    for (NSInteger index = 0; index < 5; index ++) {
        ...
        model.text =  @"大家好[呲牙], 写这个小小的#demo#起源是因为年前做项目[滑稽]，需要自己写即时通讯和朋友圈等功能，时间非常赶[噘嘴]，网上www.baidu.com和www.google.cn找了很久也没找到很合适的[白眼]可以用的代码，即使找到一些图文混排的也都有Bug或者并不完善 . [噘嘴]在空闲时间花了大概一周写了一份 , 一直不断的完善性能和修复bug , 目前为止基本上已经非常稳定了 ,项目里运用迭代也超过了5个版本 . 此外 , 还有一些很多同僚提出的意见 ,如果支持手机号和邮箱号的匹配 , 针对这些再次对该label做了相应的结构调整 [害羞]. 目前支持图片表情文字混排比如[白眼][擦汗][呲牙], 网址链接比如www.google.cn ,话题比如#这是一个话题#,at比如@Alan,手机号比如13671240056,邮箱号比如我的邮箱zq18246169120@163.com,有意见可以提出 .自己设定的文字比如这是一个自定义链接,这是另外一个自定义链接,关键字比如我是一个关键字. 也可根据文本的range进行设定链接.[卖萌] . 如果觉得有用麻烦star一下或者fork一下喔...";
